    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            ...
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h3 class="text-xl font-semibold text-gray-800">Biodata Mahasiswa</h3>
                <a href=""
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="space-y-4">
                                        <div class="grid grid-cols-3 gap-2">
                                            ...
                                            <span class="col-span-2 text-sm text-gray-600">{{ $mahasiswa->nim }}</span>
                                        </div>
                                        <div class="grid grid-cols-3 gap-2">
                                            <span class="text-sm font-medium text-gray-900">Nama Lengkap</span>
                                            <span class="col-span-2 text-sm text-gray-600">{{ $mahasiswa->user->name }}</span>
                                        </div>
                                        <div class="grid grid-cols-3 gap-2">
                                        ...
                                        <div class="grid grid-cols-3 gap-2">
                                            ...
                                            <span class="col-span-2 text-sm text-gray-600">{{ $mahasiswa->religion }}</span>
                                        </div>
                                    </div>
                                    <div class="space-y-4">
                                        <div class="grid grid-cols-3 gap-2">
                                            <span class="text-sm font-medium text-gray-900">Program Studi</span>
                                            <span class="col-span-2 text-sm text-gray-600">{{ $mahasiswa->prodi->name ?? 'Belum diatur' }}</span>
                                        </div>
                                        <div class="grid grid-cols-3 gap-2">
                                            <span class="text-sm font-medium text-gray-900">Dosen Wali</span>
                                            <span class="col-span-2 text-sm text-gray-600">{{ $mahasiswa->dosen->user->name ?? 'Belum diatur' }}</span>
                                        </div>
                                        <div class="grid grid-cols-3 gap-2">
                                            <span class="text-sm font-medium text-gray-900">Angkatan</span>
                                            <span class="col-span-2 text-sm text-gray-600">{{ $mahasiswa->angkatan }}</span>
                                        </div>
                                        <div class="grid grid-cols-3 gap-2">
                                            <span class="text-sm font-medium text-gray-900">Tahun Akademik</span>
                                            <span class="col-span-2 text-sm text-gray-600">{{ $mahasiswa->tahun_akademik }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0">
                                                <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l9-5-9-5-9 5 9 5zm0 0l9-5-9-5-9 5 9 5zm-9-5v10l9-5 9 5V9l-9-5-9 5z" />
                                                </svg>
                                            </div>
                                            <div class="ml-4">
                                                <p class="text-sm font-medium">Program Studi</p>
                                                <p class="text-lg font-bold">{{ $mahasiswa->prodi->name ?? 'Belum diatur' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-4 text-white">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <p class="text-lg font-bold">{{ $mahasiswa->dosen->user->name ?? 'Belum diatur' }}</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="bg-gray-800 rounded-lg border border-gray-700">
                                ...
                                <div class="p-6 text-center">
                                    <div class="status-indicator">
                                        ...
                                        <div class="inline-flex flex-col items-center p-6 bg-green-100 rounded-full">
                                        ...
                                        <div class="inline-flex flex-col items-center p-6 bg-red-100 rounded-full">
                                        ...
                                        @else
                                        <div class="inline-flex flex-col items-center p-6 bg-yellow-100 rounded-full">
                                            ...
                                            <span class="text-lg font-bold text-yellow-800">{{ strtoupper($mahasiswa->user->status) }}</span>
                                        </div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="p-4">
                                    <div class="space-y-3">
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span class="text-sm text-gray-600">{{ $mahasiswa->created_at->format('d F Y H:i') }}</span>
                                        </div>
                                        <div class="flex justify-between items-center">
                                            <span class="text-sm font-medium text-gray-900">Diupdate</span>
                                            <span class="text-sm text-gray-600">{{ $mahasiswa->updated_at->format('d F Y H:i') }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
