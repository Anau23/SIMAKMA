                    ...
                    <tbody>
                        @forelse ($dosen as $index => $d)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="border px-4 py-2">{{ $d->prodi->name ?? '-' }}</td>
                                <td class="border px-4 py-2">{{ $d->user->email }}</td>
                                <td class="border px-4 py-2 text-center">
                                    <button class="px-3 py-1 bg-yellow-400 text-white rounded hover:bg-yellow-500">
                                        <a href="{{ route('admin.dosen.edit', $d->id) }}">Edit</a>
                                    </button>
            ...
            <div class="md:hidden space-y-4">
                @forelse ($dosen as $d)
                    <div class="border rounded-lg p-4 shadow-sm">
                        ...
                        <p class="text-gray-600 text-sm mb-1">Prodi: {{ $d->prodi->name ?? '-' }}</p>
